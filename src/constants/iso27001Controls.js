export const ISO27001_CONTROLS = [
  ...
  { id: 'A.8.1',  name: 'User end point devices',                                                      category: 'Technological' },
...
export const CATEGORY_COLORS = {
  Organizational: { bg: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-100' },
  People:         { bg: 'bg-blue-50',   text: 'text-blue-700',   border: 'border-blue-100'   },
  Physical:       { bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-100' },
  Technological:  { bg: 'bg-teal-50',   text: 'text-teal-700',   border: 'border-teal-100'   },
};
