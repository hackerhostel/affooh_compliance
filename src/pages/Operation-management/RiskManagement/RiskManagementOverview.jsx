...
import CreateNewRisk from "./CreateNewRisk.jsx";
...
const RiskManagementOverview = ({ openUpdatePage }) => {
    ...
    return (
        <div className="relative">
            <div className={`${isOpen ? "opacity-20 pointer-events-none" : ""}`}>
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-[999]">
                    <CreateNewRisk isOpen={isOpen} onClose={handleClose} />
                </div>
            )}
