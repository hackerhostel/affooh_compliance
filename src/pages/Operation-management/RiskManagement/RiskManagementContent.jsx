        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex bg-gray-200/50 p-1 rounded-xl">
            <button
              ...
              className={`px-8 py-2 rounded-lg text-sm font-bold transition-all duration-200 ${activeTab === "overview"
            ...
            <button
              ...
              className={`px-8 py-2 rounded-lg text-sm font-bold transition-all duration-200 ${activeTab === "history"
                ? "bg-black text-white shadow-lg"
                : "text-gray-400 hover:text-gray-600"
                }`}
            >
