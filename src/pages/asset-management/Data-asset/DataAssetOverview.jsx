            ...
            {assetRows.length === 0 ? (
              ...
              assetRows.map((row, index) => (
                ...
                >
                  ...
                  <td className="py-4 px-4">{row.fullName}</td>
