...
const ProcessFrameworkListPage = ({ onDocumentSelect }) => {
  const { addToast } = useToasts();

  // Dummy document list
  const [documents, setDocuments] = useState([
    { id: 1, name: "Policy", classification: "Public" },
    { id: 2, name: "Process", classification: "Confidential" },
    { id: 3, name: "Standards", classification: "Restricted" },
    { id: 4, name: "Templates", classification: "Restricted" }
