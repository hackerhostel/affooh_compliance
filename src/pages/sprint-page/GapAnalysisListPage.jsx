            ...
            {filteredSprintList.length === 0 ? (
              ...
              filteredSprintList.map((element, index) => (
                <div
                  key={index}
                  style={{ width: "266px" }}
                  className={`flex justify-between items-center p-3 border rounded-md pr-3 gap-2 hover:bg-gray-100 hover:border-primary-pink cursor-pointer ${selectedSprint?.id === element.id ? 'border-primary-pink border-2' : 'border-gray-200'}`}
                >
