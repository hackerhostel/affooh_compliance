        ...
        <div className="flex-col gap-4">
          <div className="flex flex-col gap-4 -mt-2 pl-3 pr-3">
            ...
            <div className="flex w-full laptopL:w-60 justify-between ml-3">
              <button
                className={`px-2 py-1 rounded-xl text-xs ${selectedFilters.todo ? "bg-primary-pink text-white" : "bg-gray-200"
                  }`}
              ...
              <button
                className={`px-2 py-1 rounded-xl text-xs ${selectedFilters.inProgress ? "bg-primary-pink text-white" : "bg-gray-200"
                  }`}
              ...
              <button
                className={`px-2 py-1 rounded-xl text-xs ${selectedFilters.done ? "bg-primary-pink text-white" : "bg-gray-200"
                  }`}
          ...
          <div className="h-[calc(100vh-300px)] overflow-y-auto flex flex-col gap-3 pl-3 pr-1 mt-12">
            {filteredTestPlans.length === 0 ? (
              ...
              filteredTestPlans.slice().reverse().map((tp, index) => (
                <div
                  key={tp.id}
                  className={`flex justify-between items-center p-3 border rounded-md w-full gap-2 hover:bg-gray-100 cursor-pointer ${selectedTestPlanId === tp.id ? 'border-primary-pink border-2' : 'border-gray-200'}`}
                >
                  <div
