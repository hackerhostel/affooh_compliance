...
import { CheckCircleIcon, PlusCircleIcon, TrashIcon, XCircleIcon, EllipsisVerticalIcon } from "@heroicons/react/24/outline/index.js";
                  ...
                  <td className="px-4 py-2 ">
                    <div className={"flex gap-5"}>
                      <XCircleIcon onClick={handleCancelNewRow}
                        className="w-5 h-5 text-gray-500 cursor-pointer" />
                      <CheckCircleIcon onClick={handleSaveTimeLog}
                        className="w-5 h-5 text-primary-pink cursor-pointer" />
                    </div>
                  </td>
                </tr>
