        ...
        <div className={`${actionButtonPlacement === "side" ? "flex" : "flex-col"} items-center space-x-2`}>
            ...
            {!isEditing && isChanged && (
                <div className="flex space-x-1">
                    <button
                        onClick={onAccept}
                        className="p-1 rounded-full bg-primary-pink text-white hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-primary-pink focus:ring-offset-2 disabled:bg-gray-500"
